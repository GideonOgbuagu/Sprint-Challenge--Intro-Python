...
first_letter = ["A", "B", "C", "D", "F", "G"]
c = [human.name for human in humans if human.name[0] in first_letter]
print(c)
...
# print(new_humans)
g = [(new_human.name.upper(), (new_human.age + 5)) for new_human in new_humans]
print(g)
